function [ S, dSds] = test_irl_exp_feat(s,m,cost)
%L, S, dLdm, dLds, dSdm, dSds
%Baxter feature expectation function for IRL
%   cost: the cost struct
%   m: mean vector of state [LPos LVel RPos RVel]
%   s: covariance matrix of state
%
%   L: expected feature vector [LPos RPos]
%   S: covariance matrix of L
